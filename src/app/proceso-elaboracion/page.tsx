...
const procesoElaboracion = [
  {
    ...
    interactividadSugerencia: "Galería Interactiva: Haz clic en diferentes variedades de uva (Quebranta, Italia, Torontel) para ver imágenes detalladas y conocer sus características principales para nuestros vinos y piscos.",
  ...
  },
  {
    ...
    interactividadSugerencia: "Comparativa Visual: Toggle 'Tradicional vs. Moderno'. Al seleccionar 'Tradicional', muestra una pisada de uva (simulada). Con 'Moderno', la animación de la máquina actual.",
  ...
  },
  {
    ...
    interactividadSugerencia: "Termómetro Interactivo: Arrastra un slider de temperatura virtual (ej. 18°C vs 28°C) y observa (con texto descriptivo o iconos) cómo influye en los perfiles aromáticos.",
  ...
  },
  {
    ...
    interactividadSugerencia: "Visualizador de Color Dinámico: Una animación que muestra cómo el color del vino se intensifica gradualmente a lo largo de los días de maceración.",
  ...
  },
  {
    ...
    interactividadSugerencia: "Explora las Prensas: Diagrama interactivo. Haz clic en 'Prensa Neumática' o 'Prensa Vertical (Tradicional)' para ver una animación de su funcionamiento y ventajas.",
  ...
  },
  {
    ...
    interactividadSugerencia: "Test de Sabor Simulado: Botones 'Antes de FML' (descriptores: 'manzana verde') y 'Después de FML' (descriptores: 'mantequilla', 'textura redonda').",
  ...
  },
  {
    ...
    interactividadSugerencia: "Mapa de Aromas de Barrica: Pasa el cursor sobre una barrica para revelar aromas típicos (vainilla, coco, especias, tostado, según el tipo de roble).",
  ...
  },
  {
    ...
    interactividadSugerencia: "Filtro Virtual Interactivo: Arrastra 'vino turbio' (simbólico) a través de un 'cono de trasiego' para verlo salir 'clarificado'.",
  ...
  },
  {
    ...
    interactividadSugerencia: "Crea Tu Etiqueta (Mini-Juego): Módulo simple para seleccionar nombre de vino ficticio, diseño de etiqueta básico y ver en botella 3D.",
  ...
  },
  {
    ...
    interactividadSugerencia: "Línea de Tiempo de Potencial de Guarda: Slider simulando años (1, 3, 5, 10+). Muestra notas de cata de evolución (ej. 'fruta fresca' a 'compotada', 'cuero').",
